...
//	@Override
//	/**
//	 * This is the method with the javafx operations
//	 */
//	public void start(Stage primaryStage) throws Exception {
//		// save args example
...
//
//		//create click label
//		Button clickCounter = new Button (clicks+ " clicks");
//		clickCounter.setOnAction(
//				e -> clickCounter.setText(""+ ++clicks +" clicks")
//				);
//		
//		
//		//create button
...
//		MyHandler handler = new MyHandler(clickMeButton);
//		//register event handler for button
//		clickMeButton.setOnAction(handler);
//
//		BorderPane root = new BorderPane();
//		root.setTop(new Label(APP_TITLE));
//		root.setCenter(vbox);
//		root.setRight(clickCounter);
//		root.setBottom(clickMeButton);
//		Scene mainScene = new Scene(root,WINDOW_WIDTH,WINDOW_HEIGHT);
//
//		primaryStage.setTitle(APP_TITLE);
//		primaryStage.setScene(mainScene);
...
//
//	/**
//	 * This is the class for launching the javafx
//	 * @param args
//	 */
//	public static void main(String[] args) {
//		launch(args);
...
////		args = this.getParameters().getRaw();
////
////		//Create an ComboBox object
////		ComboBox<String> comboBox = new ComboBox();
////		//add options to the combobox
////		comboBox.getItems().add("Apple");
////		comboBox.getItems().add("Blueberry");
////		comboBox.getItems().add("Strawberry");
////
////
////		//create an ImageView
////		FileInputStream input = new FileInputStream("/Users/Candice/Desktop/cs400/photo.png");
////		Image image = new Image(input);
////		ImageView selfie = new ImageView(image);
////
...
////		
////		//Set the tile at the top panel
////		root.setTop(new Label(APP_TITLE));
////		//Set the photo in the middle of the screen
////		root.setCenter(selfie);
////		//Set the combo box at the left of the screen
////		root.setLeft(comboBox);
////		//Set the "Done" button at the bottom of the screen
////		root.setBottom(donebutton);
////		//Set the text area at the right of the screen
////		root.setRight(text);
////		
////		//Display the window
////		Scene mainScene = new Scene(root, WINDOW_WIDTH, WINDOW_HEIGHT);
